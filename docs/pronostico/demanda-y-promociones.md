...
| | |
|---|---|
| **Dónde está** | Menú: Pronóstico › Demanda y Promociones |
| **Dirección** | `/planning/demand-and-promotions` |
| **Quién la ve** | Usuarios con el permiso `planning.demand-and-promotions`. |
| **Incluye** | Demanda y Promociones (`/planning/demand-and-promotions/details`) |
