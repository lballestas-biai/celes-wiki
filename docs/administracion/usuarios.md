...
| **Dirección** | `/administration/access-control/users` |
| **Quién la ve** | Usuarios con el permiso `administration.access-control.users`, o con uno más específico dentro de él. |
