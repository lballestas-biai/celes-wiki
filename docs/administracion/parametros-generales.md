...
| **Dirección** | `/administration/configuration/general-parameters` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.general-parameters`, o con uno más específico dentro de él. |
