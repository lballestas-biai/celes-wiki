...
| **Dirección** | `/administration/configuration/reference-products` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.reference-products`, o con uno más específico dentro de él. |
