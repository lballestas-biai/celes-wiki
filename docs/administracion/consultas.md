...
| **Dirección** | `/administration/configuration/query-builder` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.query-builder`, o con uno más específico dentro de él. |
