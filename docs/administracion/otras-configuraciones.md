...
| **Dirección** | `/administration/configuration/other` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.other`, o con uno más específico dentro de él. |
