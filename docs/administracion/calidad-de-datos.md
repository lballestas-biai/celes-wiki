...
| **Dirección** | `/administration/master-data/data-quality` |
| **Quién la ve** | Usuarios con el permiso `administration.master-data.data-quality`. También la abre el permiso anterior `administration.data-manager.data-quality`. |
| **Otras direcciones** | `/administration/data-manager/data-quality` — llevan a esta misma pantalla |
