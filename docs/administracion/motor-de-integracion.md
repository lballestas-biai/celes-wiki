...
| **Dirección** | `/administration/configuration/integration-engine` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.integration-engine`, o con uno más específico dentro de él. |
