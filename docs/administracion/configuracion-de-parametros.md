...
| **Dirección** | `/administration/configuration/parameters-manager` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.parameters-manager`, o con uno más específico dentro de él. |
