...
| | |
|---|---|
| **Dónde está** | Menú: Administración › Configuración General |
| **Dirección** | `/administration/configuration` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration`, o con uno más específico dentro de él. |
