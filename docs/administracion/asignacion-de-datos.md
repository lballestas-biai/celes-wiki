...
| **Dirección** | `/administration/configuration/data-allocation` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.data-allocation`, o con uno más específico dentro de él. |
