...
| **Dirección** | `/administration/configuration/config-columns` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.config-columns`, o con uno más específico dentro de él. |
