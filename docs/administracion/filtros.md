...
| **Dirección** | `/administration/configuration/app-filters` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.app-filters`, o con uno más específico dentro de él. |
