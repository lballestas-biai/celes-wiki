...
| **Dirección** | `/administration/configuration/cubing-configurations` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.cubing-configurations`, o con uno más específico dentro de él. |
