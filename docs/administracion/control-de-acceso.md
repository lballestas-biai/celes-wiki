...
| | |
|---|---|
| **Dónde está** | Menú: Administración › Control de Acceso |
| **Dirección** | `/administration/access-control` |
| **Quién la ve** | Usuarios con el permiso `administration.access-control`, o con uno más específico dentro de él. |
