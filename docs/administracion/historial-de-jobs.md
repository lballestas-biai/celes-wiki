...
| | |
|---|---|
| **Dónde está** | Menú: Administración › Historial de Jobs |
| **Dirección** | `/administration/job-history` |
| **Quién la ve** | Usuarios con el permiso `administration.job-history`, o con uno más específico dentro de él. |
