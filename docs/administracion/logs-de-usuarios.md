...
| | |
|---|---|
| **Dónde está** | Menú: Administración › Logs de Usuarios |
| **Dirección** | `/administration/users-logs` |
| **Quién la ve** | Usuarios con el permiso `administration.users-logs`, o con uno más específico dentro de él. |
