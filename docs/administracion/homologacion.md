...
| **Dirección** | `/administration/master-data/mapping` |
| **Quién la ve** | Usuarios con el permiso `administration.master-data.mapping`. También la abre el permiso anterior `administration.data-manager.mapping`. |
| **Otras direcciones** | `/administration/data-manager/mapping` — llevan a esta misma pantalla |
