...
| **Dirección** | `/administration/data-manager/data-upload` |
| **Quién la ve** | Usuarios con el permiso `administration.data-manager.data-upload`, o con uno más específico dentro de él. |
