...
| **Dirección** | `/administration/access-control/data-permission` |
| **Quién la ve** | Usuarios con el permiso `administration.access-control.data-permission`, o con uno más específico dentro de él. |
