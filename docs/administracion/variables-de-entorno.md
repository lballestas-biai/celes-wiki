...
| **Dirección** | `/administration/configuration/environment-variables` |
| **Quién la ve** | Usuarios con el permiso `administration.configuration.environment-variables`, o con uno más específico dentro de él. |
