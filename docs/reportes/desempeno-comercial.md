...
| | |
|---|---|
| **Dónde está** | Menú: Reportes › Desempeño Comercial |
| **Dirección** | `/reports-and-analytics/commercial-performance` |
| **Quién la ve** | Usuarios con el permiso `reports-and-analytics.commercial-performance`. |
