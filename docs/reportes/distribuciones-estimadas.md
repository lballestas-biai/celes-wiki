...
| | |
|---|---|
| **Dónde está** | Menú: Reportes › Distribuciones Estimadas |
| **Dirección** | `/reports-and-analytics/replenishment-report` |
| **Quién la ve** | Usuarios con el permiso `reports-and-analytics.replenishment-report`. |
