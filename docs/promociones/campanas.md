...
| | |
|---|---|
| **Dónde está** | Menú: Promociones › Campañas |
| **Dirección** | `/promotions/campaigns` |
| **Quién la ve** | Usuarios con el permiso `promotions.campaigns`. También la abre el permiso anterior `planning.promotional-campaigns`. |
| **Otras direcciones** | `/planning/promotional-campaigns` — llevan a esta misma pantalla |
