...
| **Dirección** | `/work-area/automation/pipeline-configuration` |
| **Quién la ve** | Usuarios con el permiso `work-area.automation`. También la abre el permiso anterior `administration.operation.pipeline-configuration`. |
| **Otras direcciones** | `/administration/operation/pipeline-configuration` — llevan a esta misma pantalla |
