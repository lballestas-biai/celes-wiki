...
| | |
|---|---|
| **Dónde está** | Menú: Reabastecimiento › Solicitudes de Tiendas |
| **Dirección** | `/work-area/replenishment-suggestions` |
| **Quién la ve** | Usuarios con el permiso `work-area.replenishment-suggestions`. |
