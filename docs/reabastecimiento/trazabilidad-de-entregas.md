...
| **Dirección** | `/work-area/automation/dispatches` |
| **Quién la ve** | Usuarios con el permiso `work-area.automation`. También la abre el permiso anterior `administration.operation.dispatches`. |
| **Otras direcciones** | `/administration/operation/dispatches` — llevan a esta misma pantalla |
