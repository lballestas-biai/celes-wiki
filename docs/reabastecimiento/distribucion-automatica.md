...
| | |
|---|---|
| **Dónde está** | No aparece en el menú lateral: se llega desde otra pantalla |
| **Dirección** | `/work-area/automation/automatic-replenishment` |
| **Quién la ve** | Usuarios con el permiso `work-area.automation`. También la abre el permiso anterior `administration.operation.automatic-replenishment`. |
| **Otras direcciones** | `/administration/operation/automatic-replenishment` — llevan a esta misma pantalla |
